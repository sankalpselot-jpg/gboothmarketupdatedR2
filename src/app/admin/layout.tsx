    ...
    <div className="min-h-screen bg-cream flex">
      ...
      <aside className="w-58 bg-navy flex-shrink-0 flex flex-col min-h-screen sticky top-0" style={{ width: 232 }}>
        <div className="p-5 border-b border-white/10">
          ...
          <span className="mt-1.5 block text-[10px] font-semibold uppercase tracking-wider text-white/25">
            Admin Panel
          </span>
        </div>
        ...
        <div className="p-4 border-t border-white/10">
          ...
          <Link href="/dashboard" className="text-[12px] text-white/40 hover:text-white/70 transition-colors">
            ← Back to Account
          </Link>
        </div>
      </aside>
      ...
      <main className="flex-1 overflow-auto">
        <div className="bg-white border-b border-[#DDD8CF] px-8 py-4 flex items-center justify-between sticky top-0 z-10">
          <p className="text-sm text-[#6B6B6B]">
            Admin · <strong className="text-navy">{profile?.email}</strong>
          </p>
          <Link href="/" className="text-[13px] text-gold hover:text-gold-light transition-colors">
            View Site →
          </Link>
        </div>
